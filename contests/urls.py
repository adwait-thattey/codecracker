...
urlpatterns = [
    ...
    path('<slug:contest_unique_code>/register', views.register_for_contest, name="register"),
    path('<slug:contest_unique_code>/unregister', views.register_for_contest, name="unregister"),
