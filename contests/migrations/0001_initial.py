    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eligibility', models.TextField(help_text='What is the eligibility criteria for participants?', null=True)),
                ('rules', models.TextField(help_text='What are the rules that all participants must follow?', null=True)),
                ('prizes', models.TextField(help_text='Mention prizes for diff positions/winners (If any)', max_length=200, null=True)),
                ('contacts', models.TextField(help_text='Give your email, phone etc. so that people can contact you if they need to', null=True)),
